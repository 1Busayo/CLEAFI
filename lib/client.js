...
export const postmimes = async (data) => {
  ...
  axios.post("http://localhost:3003/addmimes", data, {
headers: {
  'Authorization': `${token}` 
}
}).then(res => {
...
export const updateprofile = async (data) => {
  ...
  axios.post("http://localhost:3003/updateprofile", data, {
headers: {
  'Authorization': `${token}` 
}
}).then(res => {
...
export const checkuser = async (data ,cb) => {
 ...
 await axios.get(`http://localhost:3003/getuser/${data}`, {
headers: {
  'Authorization': `${token}` 
}
}).then(res => {
...
export const getallmimes = async (cb) => {
  ...
  await axios.get(`http://localhost:3003/allmimesx`, {
 headers: {
   'Authorization': `${token}` 
 }
 }).then(res => {
 ...
 export const usermimes = async (data,cb) => {
  ...
  await axios.get(`http://localhost:3003/usermimes/${data}`, {
 headers: {
   'Authorization': `${token}` 
 }
 }).then(res => {
